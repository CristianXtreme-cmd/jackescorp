...
$error = $productController->update($id);
...
<head>
    ...
    <title>Editar Producto - StyleJackets</title>
    <!-- Bootstrap CSS -->
...
<body>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <p class="lead">Modifica la información del producto</p>
                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">
                            <i class="fas fa-edit me-2"></i>Editar: <?php echo htmlspecialchars($product['nombre']); ?>
                        </h5>
                    </div>
                    <div class="card-body">
                        <?php if($error): ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="talla" name="talla">
                                            ...
                                            <option value="XS" <?php echo ($product['talla'] == 'XS') ? 'selected' : ''; ?>>XS</option>
                                            <option value="S" <?php echo ($product['talla'] == 'S') ? 'selected' : ''; ?>>S</option>
                                            <option value="M" <?php echo ($product['talla'] == 'M') ? 'selected' : ''; ?>>M</option>
                                            <option value="L" <?php echo ($product['talla'] == 'L') ? 'selected' : ''; ?>>L</option>
                                            <option value="XL" <?php echo ($product['talla'] == 'XL') ? 'selected' : ''; ?>>XL</option>
                                            <option value="XXL" <?php echo ($product['talla'] == 'XXL') ? 'selected' : ''; ?>>XXL</option>
                                        </select>
                                    </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-12">
                                    <div class="alert alert-info">
                                        <strong>ID del Producto:</strong> <?php echo $product['id_producto']; ?> | 
                                        <strong>Creado:</strong> Producto existente en el sistema
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        function previewImage() {
            ...
            if (url) {
                preview.innerHTML = `
                    <label class="form-label text-muted">Nueva imagen:</label><br>
                    <img src="${url}" class="image-preview" alt="Preview" onerror="this.style.display='none'">
                `;
            } else {
                preview.innerHTML = '';
            }
